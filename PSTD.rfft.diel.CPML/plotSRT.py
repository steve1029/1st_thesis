...
class SRTpainter():
	...
	def __init__(self, where_re, where_im, dx, dy, dz, courant, wv_srt, wv_end, interval, spread, cutter1, cutter2, cutter3, wvlen_unit, freq_unit):
		...
		self.ref_re[cutter2:-1] = 0
		self.ref_im[cutter2:-1] = 0

		self.trs_re[cutter3:-1] = 0
		self.trs_im[cutter3:-1] = 0
...
if __name__ == "__main__":
	...
	painter = SRTpainter('Ey', 'Ey', dx, dy, dz, courant, wv_srt, wv_end, interval, spread, cutter1, cutter2, cutter3, wvlen_unit, freq_unit)
	painter.plot_src()
	painter.plot_trs()
	painter.plot_ref()
