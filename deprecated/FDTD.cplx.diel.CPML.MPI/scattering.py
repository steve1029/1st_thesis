...
savedir = '/home/ldg/script/pyctypes/FDTD.cplx.diel.CPML.MPI/'

nm = 1e-9
um = 1e-6

Nx, Ny, Nz = 512, 64, 64
dx, dy, dz = 10*um, 100*um, 100*um
...
for tstep in range(Tsteps):
	...
	TF.put_src('Ey_re', 'Ey_im', pulse_re, 0, 'soft')
	#TF.put_src('Ez_re', 'Ez_im', pulse_re, 0, 'soft')

	IF.put_src('Ey_re', 'Ey_im', pulse_re, 0, 'soft')
