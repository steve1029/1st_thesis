...
import source, Structure, PML, plotting, core
...
savedir = '/home/ldg/script/python/FDTD.py3/block.cpu.0c.nobar/'
...
for tstep in range(Fields.nsteps):
	...
	pulse = Src.pulse(tstep,pick_pos=2000)
...
if Space.rank == 0 : 
	...
	if not os.path.exists(record_path):
		...
		f.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n" \
			.format("MPI size","gridx","gridy","gridz","gridgapx","gridgapy","gridgapz","nsteps","cal_time"))
		f.close()

	f = open( record_path,'a')
	f.write("{}\t\t{}\t\t{}\t\t{}\t\t{}\t\t{}\t\t{}\t\t{}\t\t{}\n" \
				.format(Space.size, Space.gridx, Space.gridy, Space.gridz,\
