...
def apply_UPML(region_x, region_y, region_z, npml):
	...
	#----------------------------------------------------------------------------------#
		...
		self.CEx2 = self.offEpx / self.onEpz / self.space_eps_on
		self.CEx3 = self.offEmx / self.onEpz / self.space_eps_on * (-1)

		self.CEy1 = self.onEmx  / self.onEpx
		self.CEy2 = self.offEpy / self.onEpx / self.space_eps_on
		self.CEy3 = self.offEmy / self.onEpx / self.space_eps_on * (-1)
		...
		self.CBx1 = self.offHmy / self.offHpy
		self.CBy1 = self.offHmz / self.offHpz
		self.CBz1 = self.offHmx / self.offHpx

		self.CBx2 = 2. * mu_0 * dt / self.offHpy * (-1)
		self.CBy2 = 2. * mu_0 * dt / self.offHpz * (-1)
		self.CBz2 = 2. * mu_0 * dt / self.offHpx * (-1)
		...
		self.CHy1 = self.offHmx / self.offHpx
		self.CHy2 = self.onHpy  / self.offHpx / self.space_mu_off
		self.CHy3 = self.onHmy  / self.offHpx / self.space_mu_off * (-1)

		self.CHz1 = self.offHmy / self.offHpy
		self.CHz2 = self.onHpz  / self.offHpy / self.space_mu_on
		self.CHz3 = self.onHmz  / self.offHpy / self.space_mu_on * (-1)
